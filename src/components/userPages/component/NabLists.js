            ...
            <div className="row">
                <div className="col-12 col-md-2 justify-content-center align-items-center d-flex">
                    <div className="row justify-content-center align-items-center w-100">
                        <Link to={'/issuerLegal/meetings/company_id/' + company.id + "/active"}
                ...
                <div className="col-12 d-md-none d-flex justify-content-between">
                    ...
                    <Button onClick={() => history.push('/issuerLegal/meetings/company_id/' + company.id + "/active")}
                            className="create">
                        Всего заседаний - {company.meetingCount}
                    </Button>
                </div>
                <div className="col-md-6 d-none d-md-block"
                     onClick={() => history.push('/issuerLegal/meetings/company_id/' + company.id + "/active")}>
                    <h3>{company.name}</h3>
