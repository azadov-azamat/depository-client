        ...
        <div className={"p-3 rounded my-3 NabList"}>
            <div className="row">
                            ...
                            {company.imageUrl !== null ?
                                <>
                                    <img className="d-flex d-md-none"
                                        src={company.imageUrl} alt="bu company logo"
                                         style={{
                                             width: '100%',
                                             height: "65px",
                                         }}/>
                ...
                <div className="col-12 d-md-none d-flex justify-content-between">
                    ...
                    <Button onClick={() => history.push('/issuerLegal/meetings/company_id/' + company.id)}
                            className="create">
                        Всего заседаний - {company.meetingCount}
                    </Button>
                </div>
                <div className="col-md-6 d-none d-md-block"
                     onClick={() => history.push('/issuerLegal/meetings/company_id/' + company.id)}>
                    <h3>{company.name}</h3>
