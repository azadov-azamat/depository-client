...
export const NavbarControlMeeting = ({roleMember, companyId, memberId, countBadge, clicked}) => {
        ...
        roleMember === CHAIRMAN || roleMember === SECRETARY ?
            ...
            <>
                <ul className="nav nav-tabs d-none d-md-flex">
                    <NavItem>
                        <NavLink
                            to={"/issuerLegal/meeting/" + id + "/agenda?companyId=" + companyId + "&memberId=" + memberId} onClick={clicked}
